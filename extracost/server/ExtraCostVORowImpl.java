...
public class ExtraCostVORowImpl extends OAViewRowImpl {
    ...
    public static final int IDSTRETCH = 1;
    public static final int IDFREIGHTCHAR = 2;
    public static final int IDREQUEST = 3;
    public static final int USERATE = 4;
    public static final int IDSTATUS = 5;
    public static final int STATUS = 6;
    public static final int IDCLASSIFICATION = 7;
    public static final int CLASSIFICATION = 8;
    public static final int IDORIGIN = 9;
    public static final int ORIGIN = 10;
    public static final int IDZONE = 11;
    public static final int ZONEDESC = 12;
    public static final int IDDISTRIBUTION = 13;
    public static final int DISTRIBUTIONCODE = 14;
    public static final int DISTRIBUTION = 15;
    public static final int IDDESTINATION = 16;
    public static final int DESTINATION = 17;
    public static final int IDMEDIA = 18;
    public static final int MEDIA = 19;
    public static final int IDMODE = 20;
    public static final int MODECODE = 21;
    public static final int MODEDESC = 22;
    public static final int IDPROVIDER = 23;
    public static final int PROVIDER = 24;
    public static final int ETD = 25;
    public static final int ETDHOUR = 26;
    public static final int ETA = 27;
    public static final int ETAHOUR = 28;
    public static final int ARRIVALDATE = 29;
    public static final int ARRIVALTIME = 30;
    public static final int FREIGHTJOB = 31;
    public static final int AWBBOL = 32;
    public static final int FLIGHT = 33;
    public static final int PEDIMENT = 34;
    public static final int MULTIPLEDELIVERIESFLAG = 35;
    public static final int NUMDELIVERIES = 36;
    public static final int DOCUMENT1 = 37;
    public static final int DOCUMENT2 = 38;
    public static final int DOCUMENT3 = 39;
    public static final int DOCUMENT4 = 40;
    public static final int ATTRIBUTE1 = 41;
    public static final int ATTRIBUTE2 = 42;
    public static final int ATTRIBUTE3 = 43;
    public static final int ATTRIBUTE4 = 44;
    public static final int ATTRIBUTE5 = 45;
    public static final int ATTRIBUTE6 = 46;
    public static final int ATTRIBUTE7 = 47;
    public static final int ATTRIBUTE8 = 48;
    public static final int ATTRIBUTE9 = 49;
    public static final int ATTRIBUTE10 = 50;
    public static final int LASTUPDATEDATE = 51;
    public static final int LASTUPDATEDBY = 52;
    public static final int CREATIONDATE = 53;
    public static final int CREATEDBY = 54;
    public static final int LASTUPDATELOGIN = 55;
    public static final int INVOICESTATUS = 56;
    public static final int UO = 57;
    ...
    /**Gets the attribute value for the calculated attribute Uo
     */
    public String getUo() {
        return (String) getAttributeInternal(UO);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute Uo
     */
    public void setUo(String value) {
        setAttributeInternal(UO, value);
    }
}
