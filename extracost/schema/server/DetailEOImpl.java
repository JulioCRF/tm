package xxgam.oracle.apps.xbol.tm.extracost.schema.server;
...
public class DetailEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxgam.oracle.apps.xbol.tm.extracost.schema.server.DetailEO");
        }
    ...
    /**Gets the attribute value for IdExtraCost, using the alias name IdExtraCost
     */
    public Number getIdExtraCost() {
        return (Number)getAttributeInternal(IDEXTRACOST);
    }

    /**Sets <code>value</code> as the attribute value for IdExtraCost
     */
    public void setIdExtraCost(Number value) {
        setAttributeInternal(IDEXTRACOST, value);
    }

    /**Gets the attribute value for IdFreightChar, using the alias name IdFreightChar
     */
    public String getIdFreightChar() {
        return (String)getAttributeInternal(IDFREIGHTCHAR);
    }

    /**Sets <code>value</code> as the attribute value for IdFreightChar
     */
    ...
    /**Gets the attribute value for RetentionFlag, using the alias name RetentionFlag
     */
    public String getRetentionFlag() {
        return (String)getAttributeInternal(RETENTIONFLAG);
    }

    /**Sets <code>value</code> as the attribute value for RetentionFlag
     */
    ...
    /**Gets the attribute value for TypeExtraCost, using the alias name TypeExtraCost
     */
    public String getTypeExtraCost() {
        return (String)getAttributeInternal(TYPEEXTRACOST);
    }

    /**Sets <code>value</code> as the attribute value for TypeExtraCost
     */
