...
// ---------------------------------------------------------------------
public class ZonesVORowImpl extends OAViewRowImpl {
    public static final int ZONEID = 0;
     ...
     */
    public ZonesVORowImpl() {
    }

    /**Gets the attribute value for the calculated attribute ZoneId
     */
    public Number getZoneId() {
        return (Number) getAttributeInternal(ZONEID);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute ZoneId
     */
