...
// ---------------------------------------------------------------------
public class OriginVORowImpl extends OAViewRowImpl {
    public static final int ORIGINID = 0;
     ...
     */
    public OriginVORowImpl() {
    }

    /**Gets the attribute value for the calculated attribute OriginId
     */
    public Number getOriginId() {
        return (Number) getAttributeInternal(ORIGINID);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute OriginId
     */
    public void setOriginId(Number value) {
