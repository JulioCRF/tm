...
// ---------------------------------------------------------------------
public class PriorityVORowImpl extends OAViewRowImpl {
    public static final int PRIORITYID = 0;
    public static final int MATERIALID = 1;
    public static final int CODE = 2;
    public static final int PRIORITY = 3;
    public static final int ATENTIONHOURS = 4;
     ...
     */
    public PriorityVORowImpl() {
    }

    /**Gets the attribute value for the calculated attribute PriorityId
     */
    public Number getPriorityId() {
        return (Number) getAttributeInternal(PRIORITYID);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute PriorityId
     */
    public void setPriorityId(Number value) {
        setAttributeInternal(PRIORITYID, value);
    }

    /**Gets the attribute value for the calculated attribute MaterialId
     */
    public Number getMaterialId() {
        return (Number) getAttributeInternal(MATERIALID);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute MaterialId
     */
    public void setMaterialId(Number value) {
    ...
    /**Gets the attribute value for the calculated attribute AtentionHours
     */
    public String getAtentionHours() {
        return (String) getAttributeInternal(ATENTIONHOURS);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute AtentionHours
     */
    public void setAtentionHours(String value) {
        setAttributeInternal(ATENTIONHOURS, value);
    }
